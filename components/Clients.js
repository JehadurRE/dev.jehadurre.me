      ...
      <div className="content">
        ...
        <div className="box-items">
          <div className="box-item">
            <div className="image">
              <a target="_blank" href="https://www.bchrd.org">
                <img src="images/clients/bchrd.png" alt="" />
                <span className="info">
          ...
          <div className="box-item">
            <div className="image">
              <a target="_blank" href="https://www.titc.com.au">
                <img src="images/clients/titc.png" alt="" />
                <span className="info">
                  <span className="centrize full-width">
                    <span className="vertical-center">
                      <span className="ion ion-link" />
